...
The example uses the CPS longitudinal dataset.[^cps-source]

[^cps-source]: Source: [`cps_long.csv` from the stata2R project](https://github.com/stata2r/stata2r.github.io/blob/main/data/cps_long.csv).
